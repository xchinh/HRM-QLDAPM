...
-   **Trạng thái đa dạng**: Present, Late, Absent, Leave
...
# Init database với sample data
docker cp sample_data.sql postgres_db:/sample_data.sql
docker exec -it postgres_db psql -U postgres -d HRM -f /sample_data.sql
